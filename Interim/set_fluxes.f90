...
! INSERT your code here to set "fluxj_xmom(i,j)"
          ...
          ! this is the lower surface in x direction
        end do
      end do
...
! INSERT your code here to set "fluxi_ymom(i,j)"
      do i=1,ni
        do j=1,nj-1
          ...
          ! this is the left surface in y direction
        end do
      end do
...
! INSERT your code here to set "fluxj_ymom(i,j)"
      do i=1,ni-1
        do j=1,nj
          ...
          ! this is the lower surface in y direction... check afterwards
        end do
      end do
...
! INSERT your code here to set "fluxi_enth(i,j)"
      do i=1,ni
        do j=1,nj-1
          ...
          ! assuming using stag condition CHECK possibly wrong here
        enddo
      enddo
